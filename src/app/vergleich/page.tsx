      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {ships.length === 0 && (
          <div className="flex flex-col items-center justify-center py-28 text-center">
            ...
            <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">Search above to add up to 5 vessels for comparison</p>
          </div>
        )}
              ...
              {SPEC_ROWS.map((row, rowIdx) => {
                ...
                return (
                  <>
                    ...
                    >
                      <span className="text-[10px] uppercase tracking-widest font-medium text-slate-400 dark:text-slate-500 whitespace-nowrap">
                        {row.label}
                      </span>
                    </div>
