...
export default function UsersPage() {
  ...
  const inp = "bg-slate-300 dark:bg-slate-800 border border-slate-400 dark:border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-900 dark:text-white outline-none focus:border-blue-500";
  const inpSm = "bg-slate-300 dark:bg-slate-800 border border-slate-400 dark:border-slate-700 rounded-lg px-3 py-1.5 text-sm text-slate-900 dark:text-white outline-none focus:border-blue-500 w-full";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
        {/* Add User Form */}
        <div className="bg-card border border-slate-400 dark:border-slate-800 rounded-2xl p-6">
        ...
        <div className="bg-card border border-slate-400 dark:border-slate-800 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            {users.map(u => (
              <div key={u.id} className="rounded-xl bg-slate-300 dark:bg-slate-800/50 hover:bg-slate-300 dark:hover:bg-slate-800 transition-colors">
                {/* Main row */}
                ...
                {changePwUser === u.username && (
                  <div className="px-4 pb-3 pt-1 border-t border-slate-400 dark:border-slate-700">
