...
export default function ShipDetailPage({
  ...
  const specs = [
    ...
    ...((ship as any).owner ? [{ icon: Building2, label: "Registered Owner", value: (ship as any).owner }] : []),
    ...((ship as any).manager ? [{ icon: Building2, label: "Ship Manager", value: (ship as any).manager }] : []),
    ...((ship as any).ismManager ? [{ icon: Building2, label: "ISM Manager", value: (ship as any).ismManager }] : []),
