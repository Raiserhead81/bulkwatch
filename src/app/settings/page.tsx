...
export default function SettingsPage() {
  ...
  const inp = "w-full bg-slate-300 dark:bg-slate-800 border border-slate-400 dark:border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-900 dark:text-white outline-none focus:border-blue-500";
        ...
        <div className="bg-card border border-slate-400 dark:border-slate-800 rounded-2xl p-6">
          ...
          <div className="space-y-2">
            {navItems.map(([label, href, icon], idx) => (
              <div
                key={href}
                className="flex items-center justify-between bg-slate-300 dark:bg-slate-800/60 rounded-xl px-4 py-2.5"
              >
          ...
          <div className="mt-6 pt-4 border-t border-slate-400 dark:border-slate-700">
            <a href="/users" className="inline-flex items-center gap-2 px-4 py-2 bg-slate-300 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 rounded-lg text-sm font-medium">
              👤 User Management
            </a>
          </div>
        </div>
